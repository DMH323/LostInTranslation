...
public class LanguageCodeConverter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(converter.fromLanguageCode("en")); // should print "English"
        System.out.println(converter.fromLanguage("French")); // should print "fr"
        System.out.println(converter.getNumLanguages()); // should print the number of languages loaded
    }
}
